...
*Version: 5.1 — Updated 2026-06-25*  
*Previous version: 5.0 (2026-03-17)*  
*Changes this version: Repository Structure section rewritten to reflect actual multi-repo layout; version control note added to Tech Stack. Added style-guide document library tool and docs/style-guide/ structure.*
...
- **Version control**: GitHub (`tiaa-forum-org` organisation) — each plugin is its own repo; see Repository Structure below
...
Each plugin and the site documentation live in **separate GitHub repositories** under the `tiaa-forum-org` organisation. Each has its own git context in IntelliJ IDEA. This Claude project is the one place that ties all repos together conceptually.

| Repo | GitHub URL | Contains |
|------|-----------|---------|
| `tiaa-wpsite-v3` | github.com/tiaa-forum-org/tiaa-wpsite-v3 | Docs, Elementor template exports (JSON), Docker Compose config |
| `tiaa-wpplugin` | github.com/tiaa-forum-org/tiaa-wpplugin | Discourse integration, join flow, welcome messages, clickable cards JS |
| `tiaa-elementor-forms-invite-action` | github.com/tiaa-forum-org/tiaa-elementor-forms-invite-action | Elementor Pro form action for invite/join flow |
| `tiaa-quick-edit` | github.com/tiaa-forum-org/tiaa-quick-edit | Admin utility: Sort Order + Excerpt in WP Quick Edit |

### tiaa-wpsite-v3 (docs + exports)
```
tiaa-wpsite-v3/
├── docs/
...
```
tiaa-wpplugin/
├── lib/                      # Core PHP classes (TiaaBase, TiaaHooks, Discourse, etc.)
├── admin/                    # WP Admin pages
├── assets/                   # Static assets
└── tiaa-wpplugin.php         # Plugin entry point
```

### tiaa-elementor-forms-invite-action
```
tiaa-elementor-forms-invite-action/
├── form-action/              # Elementor form action class
├── assets/js/                # form-handler.js
└── tiaa-elementor-forms-invite-action.php
```
...
├── tiaa-quick-edit.css       # Admin styles
├── tiaa-quick-edit-debug.js  # Optional diagnostic script
