...
*Version: 4.0 — Updated 2026-03-14*  
*Previous version: 3.0 (March 2026)*  
*Changes this version: date/time format adopted; Hot Topics count corrected 10→11; page widths added to Design System; Guide Index updated; 03-content-model.md marked current; HotTopicPostOrder.md updated; new guides 05 and 06 reflected; new reference doc from imported repo added.*
...
## Current Build State (as of 2026-03-14)
...
- ✅ **Use date and time for all document dating** — format `YYYY-MM-DD`, not month names (e.g. `2026-03-14`, not "March 2026")
...
*Instructions version: 4.0 — Updated 2026-03-14*
